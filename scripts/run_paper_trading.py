...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="جمع‌آوری دادهٔ مرجع کوینبیس (فاز A نقشهٔ چندبازاره) رو خاموش کن — فقط جمع‌آوریه، "
...
def main() -> None:
    ...
    # فاز A نقشهٔ چندبازاره: جمع‌آوریِ بهترین‌تلاشِ دادهٔ مرجع کوینبیس برای همون
